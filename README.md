## The DATA SCIENCE, Achitecture, AI AND ML Series - The files have be be diownloaded & opened on your browser (html) or in R (Rmd) the md files only provide a portion of the content.
